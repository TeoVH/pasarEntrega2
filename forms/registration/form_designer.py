...
class FormRegisterDesigner():
    ...
    def __init__(self):
        ...
        title = tk.Label(frame_form_top, text="Registro de usuario", font=(
            'Roboto', 30), fg="#666a88", bg='#fcfcfc', pady=30)
        ...
        self.usuario = ttk.Entry(frame_form_fill, font=('Roboto', 14))
        ...
        self.confirmation = ttk.Entry(frame_form_fill, font=('Roboto', 14))
        ...
        inicio = tk.Button(frame_form_fill, text="Registrar", font=(
            'Roboto', 15), bg='#accc54', bd=0, fg="#fff", command=self.register)
