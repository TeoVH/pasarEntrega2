...
from forms.master.form_puntos import FormularioPuntosDesign

class MasterPanel(tk.Tk):

    def __init__(self):
        super().__init__()
        self.logo = util_img.leer_imagen("./imagenes/logo.png", (345, 345))
    ...
    def controles_barra_superior(self):
        ...
        self.labelTitulo = tk.Label(
            self.barra_superior, text="ReciOil App")
        self.labelTitulo.config(fg="#fff", font=(
    ...
    def controles_menu_lateral(self):
        ...
        buttons_info = [
            ("Aceite", "\ue4c5", self.buttonDashBoard,self.abrir_panel_graficas ),
            ("Perfil", "\uf007", self.buttonProfile,self.abrir_panel_en_construccion),
            ("Puntos", "\uf3c5", self.buttonPicture,self.abrir_panel_puntos),
            ("Desarrollo", "\uf129", self.buttonInfo,self.abrir_panel_info),
            ("Volver", "\uf30a", self.buttonSettings,self.abrir_volver)
        ]
    ...
    def abrir_panel_puntos(self):
        self.limpiar_panel(self.cuerpo_principal)
        FormularioPuntosDesign(self.cuerpo_principal)   
